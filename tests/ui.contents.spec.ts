...
test(
	'BD-055: User should see the content according to the About Us information',
	{
		annotation: {
			type: 'test case',
			description: 'https://qasdemo.eu2.qasphere.com/project/BD/tcase/55',
		},
	},
	async ({ page }) => {
...
test(
	'BD-026: Correct display of blocks and buttons in the navbar',
	{
		annotation: {
			type: 'test case',
			description: 'https://qasdemo.eu2.qasphere.com/project/BD/tcase/26',
		},
	},
	async ({ page }) => {
...
test(
	'BD-038: User should see the Pizzas list by default on the Todays Menu block',
	{
		annotation: {
			type: 'test case',
			description: 'https://qasdemo.eu2.qasphere.com/project/BD/tcase/38',
		},
	},
	async ({ page }) => {
		const menu = new Menu(page)
...
test(
	'BD-052: User should see the Todays Menu block after clicking the Todays Menu button in the Welcome banner',
	{
		annotation: {
			type: 'test case',
			description: 'https://qasdemo.eu2.qasphere.com/project/BD/tcase/52',
		},
	},
	async ({ page }) => {
		const welcome = new Welcome(page)
